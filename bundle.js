...
/***/ function(module, exports, __webpack_require__) {
	...
	var small_func = __webpack_require__(8);

	var setMoveFunc = small_func.setMove;
	var checkWin = small_func.check;
	var notEmpty = small_func.notEmptyElement;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var successSignUp = function successSignUp(data) {
	  ...
	  api.signIn(data.credentials.email, data.credentials.password).done(ui.signInSuccess).fail(ui.failure);
	};
